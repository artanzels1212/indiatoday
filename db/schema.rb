...
ActiveRecord::Schema.define(version: 20160619183729) do
  ...
  add_index "cities", ["state_id"], name: "fk_rails_59b5e22e07", using: :btree
  ...
  create_table "imp_fields", force: :cascade do |t|
    t.string   "name",       limit: 255
    t.datetime "created_at",             null: false
    t.datetime "updated_at",             null: false
  end
  ...
  create_table "statutories", force: :cascade do |t|
    t.string   "pan_img_file_name",    limit: 255
    t.string   "pan_img_content_type", limit: 255
    t.integer  "pan_img_file_size",    limit: 4
    t.datetime "pan_img_updated_at"
